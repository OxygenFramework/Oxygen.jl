...
"""
function router(taggedroutes::Dict{String, TaggedRoute}, prefix::String = ""; 
    ...
    return createrouter(taggedroutes, prefix, tags, middleware, interval, cron)
end

function createrouter(taggedroutes::Dict{String, TaggedRoute}, prefix::String, 
