...
"""
function router(taggedroutes::Dict{String, TaggedRoute}, custommiddleware::Dict{String, Tuple}, prefix::String = ""; 
    ...
    return createrouter(taggedroutes, custommiddleware, prefix, tags, middleware, interval, cron)
end

function createrouter(taggedroutes::Dict{String, TaggedRoute}, custommiddleware::Dict{String, Tuple}, prefix::String, 
    ...
    return function(path = nothing; 
        ...
        return function(httpmethod::String)
            ...
            if !(isnothing(routermiddleware) && isnothing(middleware))
                ...
                custommiddleware["$httpmethod|$path"] = (routermiddleware, middleware)
            end
